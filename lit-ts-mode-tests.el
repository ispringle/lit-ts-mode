...
(ert-deftest lit-ts-mode-test-js-derives-from-js-ts-mode ()
  "lit-js-ts-mode should derive from js-ts-mode."
  (should (eq (get 'lit-js-ts-mode 'derived-mode-parent) 'js-ts-mode)))

(ert-deftest lit-ts-mode-test-ts-derives-from-typescript-ts-mode ()
  "lit-typescript-ts-mode should derive from typescript-ts-mode."
  (should (eq (get 'lit-typescript-ts-mode 'derived-mode-parent)
              'typescript-ts-mode)))
